	...
	import testClasses.RequestHandlerSpeech;
	...
	public class SpeechMain {
		...
		protected void startSpeechThread() {
			...
			speechThread = new Thread(() -> {
				...
				RequestHandlerSpeech requestHandler = new RequestHandlerSpeech();
		...
		public void makeDecision(String speech) {
			...
			if ("your a bitch".equalsIgnoreCase(speech)){
			...
			}else if ("hey jarvis send a text message to tony saying whats up".equalsIgnoreCase(speech)){
				// need to import logic
				
				textToSpeech.speak("yes master", 1.5f, false, true);
				return;
			}else if ("hey jarvis open apps".equalsIgnoreCase(speech)){
				textToSpeech.speak("yes master", 1.5f, false, true);
			}else if ("hey jarvis lock the back door".equalsIgnoreCase(speech)){
				 textToSpeech.speak("yes master", 1.5f, false, true);
				return;
			}else if ("hey jarvis call tony".equalsIgnoreCase(speech)){
				 textToSpeech.speak("yes master", 1.5f, false, true);
				return;
